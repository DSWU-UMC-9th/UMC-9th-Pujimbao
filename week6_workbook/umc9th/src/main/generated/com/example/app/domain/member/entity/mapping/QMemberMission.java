...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 986198319L;
    ...
    public final com.example.app.domain.member.entity.QMember member;

    public final com.example.app.domain.mission.entity.QMission mission;
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.example.app.domain.member.entity.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new com.example.app.domain.mission.entity.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
