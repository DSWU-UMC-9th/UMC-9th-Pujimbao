...
public class QMemberTerm extends EntityPathBase<MemberTerm> {
    ...
    private static final long serialVersionUID = 605319081L;
    ...
    public final com.example.app.domain.term.entity.QTerm term;
    ...
    public QMemberTerm(Class<? extends MemberTerm> type, PathMetadata metadata, PathInits inits) {
        ...
        this.term = inits.isInitialized("term") ? new com.example.app.domain.term.entity.QTerm(forProperty("term")) : null;
    }
